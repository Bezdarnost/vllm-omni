...
| `SanaSprintPipeline` | Sana-Sprint 0.6B | `Efficient-Large-Model/Sana_Sprint_0.6B_1024px_diffusers` | ✅︎ | | | | [RTX 5080 recipe](https://github.com/vllm-project/vllm-omni/blob/main/recipes/NVIDIA/Sana-Sprint-0.6B-RTX5080.md) |
